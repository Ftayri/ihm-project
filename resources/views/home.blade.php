...
@section('navbar-class')
    ...
    @section('content')
                ...
                <div class="ypj-fluid-container">
                    <div class="row">
                        <div class="col-xl-7 col-lg-8 col-md-10 col-sm-11 col-12">
                            <div class="d-flex align-items-md-center mb-1 flex-md-row flex-column">

                                <div class="d-flex align-items-center"><i
                                        class="icon icon-medal text-primary icon-lg mr-1"></i><strong class="text-dark">Élu
                                        meilleure plateforme</strong><button
                                        class="btn btn-circle rounded-circle-box p-1 ml-n1"
                                        data-content="MonDomiService est élu le meilleur platform de service à domicile en Tunisie"
                            ...
                            <div class="row" id="homeSearchBar">
                                <div class="col-xl-7 col-lg-8 col-md-9">
                                    <div style="max-width: 400px;"
                                        id="SearchBarApp-react-component-0f75214b-e229-4d39-8431-befee6dc4b15">
                                    </div>
            ...
            <div class="ypj-fluid-container pt-6 mb-n3">
                <div class="row d-flex align-items-end">
                    <div class="col-lg-6 col-md-8">
                        ...
                        <p class="text-muted">Pour chaque situation, trouvez le prestataire dont les compétences répondent
                            à vos
                            attentes et à votre niveau d’exigence.</p>
                    </div>
                    <div class="col d-none d-lg-flex justify-content-end">
                        <div class="text-right font-weight-normal mb-3"><span
                                class="text-primary font-weight-medium">-50%</span>
                        ...
                        <div class="d-flex flex-column mb-grid-gutter">
                            <div class="category-hover">
                                <div class="frosted-glass-shadow">
                                    <div class="picture"><img alt="{{ $serviceCategory->name }}"
                                            class="radius-m img-contain" style="height: 180px" loading="lazy"
                                ...
                                <div class="mt-2"><a
                                        ...
                                        href="{{ route('services.show', ['serviceCategory' => $serviceCategory->slug]) }}">{{ $serviceCategory->name }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @foreach ($serviceSubCategories as $serviceSubCategory)
                    <div class="col position-relative">
                        <div class="category-hover">
                            ...
                            <div class="mt-2"><a
                                    class="text-decoration-none text-dark stretched-link font-weight-bold font-size-4"
                                    href="{{ route('services.subcategory.show', ['serviceCategory' => $serviceSubCategory->serviceCategory->slug, 'serviceSubCategory' => $serviceSubCategory->slug]) }}">
                                    {{ $serviceSubCategory->name }}</a></div>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="ypj-fluid-container mt-n2"><a class="font-size-3 font-weight-medium d-block mt-3 askService"
                href="{{ route('services.index') }}">Voir tous les services<i
                    class="icon-angle-right pl-1 font-size-1"></i></a></div>
        <div class="ypj-fluid-container">
            <div class="mt-6">
                ...
                <div class="row mt-4">
                    <div class="col-md-3 col-sm-6"><i class="icon-user-check font-size-5 mb-2 text-primary"></i>
                        ...
                        <p class="text-muted mb-3 mb-md-0">Tous les prestataires sont vérifiés, suivis et évalués pour
                            chaque
                    ...
                    <div class="col-md-3 col-sm-6"><i class="icon-shield-check font-size-5 mb-2 text-primary"></i>
                        ...
                        <p class="text-muted mb-3 mb-md-0">Toutes les prestations sont couvertes par notre assurance AXA,
                            qu’il
                    ...
                    <div class="col-md-3 col-sm-6"><i class="icon-wallet font-size-5 mb-2 text-primary"></i>
                        ...
                        <p class="text-muted mb-3 mb-md-0">Tous les prix sont définis à l’avance, les prestataires
                            s’engagent à les
                    ...
                    <div class="col-md-3 col-sm-6"><i class="icon-phone font-size-5 mb-2 text-primary"></i>
                        ...
                        <p class="text-muted mb-3 mb-md-0">Notre service client est à votre disposition 7j/7 pour vous
                            assurer une
                ...
                <div class="row py-5 px-2 radius-l border d-flex align-items-center ypj-in-numbers-bg mx-auto">
                    <div class="col-lg-7 col-12 mb-md-3">
                        <div class="mx-lg-5">
                            ...
                            <p class="text-muted mb-0">Tentez l’expérience et faites nous confiance comme plus de 600 000
                                clients qui
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-4 my-3">
                                <div class="d-flex align-items-start">
                                    <div class="font-size-5 ypj-in-numbers-icon bg-primary"><i class="icon-work"></i>
                                    </div>
                                    <div class="d-flex flex-column"><span class="font-size-5 mb-0 font-weight-medium">1
                                            505
                            ...
                            <div class="col-12 col-xl-4 my-3">
                                <div class="d-flex align-items-start">
                                    <div class="font-size-5 ypj-in-numbers-icon bg-secondary"><i class="icon-user"></i>
                                    </div>
                                    <div class="d-flex flex-column"><span class="font-size-5 mb-0 font-weight-medium">40
                                            000</span><span class="text-muted font-size-4">Prestataires actifs</span></div>
                                </div>
                            </div>
                            <div class="col-12 col-xl-4 mt-3">
                                <div class="d-flex align-items-start">
                                    <div class="font-size-5 ypj-in-numbers-icon bg-warning"><i class="icon-star"></i>
                                    </div>
                                    <div class="d-flex flex-column"><span
                                            class="font-size-5 mb-0 font-weight-medium">4,9<span
                                                class="font-size-3 font-weight-bold">/5</span></span><span
                                            class="text-muted font-size-4">Note
                ...
                <div class="mt-5">
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-4 text-center col-hiw p-3 mb-3 mb-sm-0"><img
                                src="{{ asset('img/demander_service.svg') }}" width="200" height="200" />
                            <p class="h5 font-weight-medium mt-2">Demandez un service</p>
                            <p class="font-size-3 font-weight-normal text-muted hiw-text-size">Remplissez le formulaire et
                                obtenez une
                                estimation du prix et de la durée</p>
                        </div>
                        <div class="col-sm-4 text-center col-hiw p-3 mb-3 mb-sm-0"><img
                                src="{{ asset('img/reserver_prestataire.svg') }}" width="200" height="200" />
                            <p class="h5 font-weight-medium mt-2">Réservez votre prestataire</p>
                            <p class="font-size-3 font-weight-normal text-muted hiw-text-size">Des prestataires compétents
                                et proches
                                de chez vous vous proposent leurs services</p>
                        </div>
                        <div class="col-sm-4 text-center col-hiw p-3 mb-3 mb-sm-0"><img src="{{ asset('img/fini.svg') }}"
                                width="200" height="200" />
                            <p class="h5 font-weight-medium mt-2">Souriez, c&#39;est fait !</p>
                            <p class="font-size-3 font-weight-normal text-muted hiw-text-size">Votre prestataire vous rend
                                service au
